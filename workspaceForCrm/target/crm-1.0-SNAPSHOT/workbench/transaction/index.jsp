			...
			<div style="position: relative;top: 10px;">
				<table class="table table-hover">
					...
					<tbody>
							...
							<td><input type="checkbox" /></td>
							<td><a style="text-decoration: none; cursor: pointer;" onclick="window.location.href='workbench/transaction/detail.do?id=980e8f12f7bc40038ddc811178f169cf';">交易123</a></td>
							<td>阿里巴巴</td>
							<td>谈判/复审</td>
							<td>新业务</td>
							<td>zhangsan</td>
